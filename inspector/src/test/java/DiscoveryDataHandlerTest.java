...
public class DiscoveryDataHandlerTest{
  ...
  Host host;
   ...
   public void testQuery(){
      ...
      String hope = "INSERT INTO device(hostname, discovered) SELECT 'kindle-6b8dcf313.hsd1.ca.comcast.net', '2016-07-12T08:52:13' FROM dual WHERE NOT EXISTS (SELECT * FROM device WHERE hostname = 'kindle-6b8dcf313.hsd1.ca.comcast.net'); UPDATE device SET ip_addr=-1398275839, last_seen='2016-07-12T08:52:13', vendor='Apple', mac='E0:88:5D:D2:6C:53' WHERE hostname ='kindle-6b8dcf313.hsd1.ca.comcast.net';";
